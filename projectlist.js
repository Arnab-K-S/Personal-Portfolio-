const projects = [
        {"slno":'1',"name": "Personal Portfolio",           'url':'','repo':'','description':` (This website)`},
    { "slno": '2', "name": "Real-Time-Chat App Solochat", 'url': '', 'repo':'https://github.com/Arnab-K-S/Real-Time-Chat-App-2.0','description':` `},
        {"slno":'3',"name": "Real-Time-Chat-App 2.0",       'url':'https://arnab-k-s.github.io/Real-Time-Chat-App-2.0/login-local.html','repo':'','description':` `},
    { "slno": '4', "name": "Real-Time-Chat-App", 'url': '', 'repo':'https://github.com/Arnab-K-S/Real-Time-Chat-App','description':` `},
    { "slno": '5', "name": "Coding Website", 'url': 'https://arnab-k-s.github.io/ARNAB-CODING-WEBSITE', 'repo':'https://github.com/Arnab-K-S/ARNAB-CODING-WEBSITE','description':` `},
        // {"slno":'6',"name": "",             'url':'','repo':'','description':` `},
        // {
        //     "slno":' ',
        //     "name": " ",
        //     'url':'',
...
A total of 20 amphibians, 12 lizards, 18 snakes, 6 turtle and tortoise species have been listed here. Considering the aforementioned factors, the area attracts a lot of researchers, students and wildlife photographers other than the regular tourists.`
    ...
    { "slno": '2', "name": "E-Libary Project", 'teamname': 'Coding Noobs', 'url': '', 'repo': '', 'description': ` ` },
]
